...
TILE_ATTR = {
    air           :{LUMINOSITY:255},
    bedrock       :{ID:1,  FRICTION:0.8,  LUMINOSITY:0,   HEALTH:INF, INFLAMMABLE:None, LTIMPERMEABILITY:0},
    obsidian      :{ID:2,  FRICTION:0.8,  LUMINOSITY:0,   HEALTH:100, INFLAMMABLE:0,    LTIMPERMEABILITY:0},
    hellstone     :{ID:3,  FRICTION:0.8,  LUMINOSITY:255, HEALTH:100, INFLAMMABLE:0,    LTIMPERMEABILITY:0},
    unobtaniumOre :{ID:4,  FRICTION:0.8,  LUMINOSITY:160, HEALTH:90,  INFLAMMABLE:None, LTIMPERMEABILITY:0},
    diamondOre    :{ID:5,  FRICTION:0.8,  LUMINOSITY:175, HEALTH:90,  INFLAMMABLE:None, LTIMPERMEABILITY:0},
    platinumOre   :{ID:6,  FRICTION:0.8,  LUMINOSITY:160, HEALTH:80,  INFLAMMABLE:None, LTIMPERMEABILITY:0},
    goldOre       :{ID:7,  FRICTION:0.8,  LUMINOSITY:160, HEALTH:70,  INFLAMMABLE:None, LTIMPERMEABILITY:0},
    ironOre       :{ID:8,  FRICTION:0.8,  LUMINOSITY:160, HEALTH:70,  INFLAMMABLE:None, LTIMPERMEABILITY:0},
    granite       :{ID:9,  FRICTION:0.8,  LUMINOSITY:0,   HEALTH:55,  INFLAMMABLE:None, LTIMPERMEABILITY:0},
    quartz        :{ID:10, FRICTION:0.8,  LUMINOSITY:0,   HEALTH:55,  INFLAMMABLE:None, LTIMPERMEABILITY:0},
    limestone     :{ID:11, FRICTION:0.8,  LUMINOSITY:0,   HEALTH:55,  INFLAMMABLE:None, LTIMPERMEABILITY:0},
    copperOre     :{ID:12, FRICTION:0.8,  LUMINOSITY:160, HEALTH:60,  INFLAMMABLE:None, LTIMPERMEABILITY:0},
    greystone     :{ID:13, FRICTION:0.8,  LUMINOSITY:0,   HEALTH:55,  INFLAMMABLE:None, LTIMPERMEABILITY:0},
    sandstone     :{ID:14, FRICTION:0.8,  LUMINOSITY:0,   HEALTH:50,  INFLAMMABLE:None, LTIMPERMEABILITY:0},
    gravel        :{ID:15, FRICTION:0.8,  LUMINOSITY:0,   HEALTH:50,  INFLAMMABLE:None, LTIMPERMEABILITY:0},
